...
public class Agent : MonoBehaviour
{
    ...
    // ✅ NEW: small manual nudge for roam center, in case a building's sprite
    // doesn't sit exactly on its logical tile center (e.g. was shifted for
    // visual alignment with neighboring buildings)
    [SerializeField] public float roamCenterYOffset = 0f;
